	...
	return [
		{
			...
			prices: {
				unitPrice: "9.95",
				pricebookEntryId: "01uHp00000PeD0NIAA",
				listPrice: null
			},
			...
			mediaGroups: [
				{
					...
					id: "2mgHp000001Zc98IAG",
					mediaItems: [
						{
							alternateText: null,
							contentVersionId: "5OUHp000000GhEmOA0",
							id: "2pmHp000000Y3s6IAC",
							mediaType: "Image",
							sortOrder: 0,
							thumbnailUrl: null,
				...
				},
				{
					...
					id: "2mgHp000001Zc99IAG",
					mediaItems: [
						{
							alternateText: null,
							contentVersionId: "5OUHp000000GhEmOA0",
							id: "2pmHp000000Y3s7IAC",
							mediaType: "Image",
							sortOrder: 0,
							thumbnailUrl: null,
							title: "Dark Roast Coffee",
		...
		},
		{
			...
			prices: {
				unitPrice: "12",
				pricebookEntryId: "01uHp00000PGIW0IAA",
				listPrice: null
			},
			...
			mediaGroups: [
				{
					...
					mediaItems: [
						{
							alternateText: null,
							contentVersionId: "5OUHp000000GhEnOA0",
							id: "2pmHp000000Y3s8IAS",
							mediaType: "Image",
							sortOrder: 0,
							thumbnailUrl: null,
		...
		},
		{
			...
			prices: {
				unitPrice: "9.95",
				pricebookEntryId: "01uHp00000PGIW1IAA",
				listPrice: null
			},
					...
					mediaItems: [
						{
							...
							contentVersionId: "5OUHp000000GhEoOA0",
							id: "2pmHp000000Y3sAIAC",
							mediaType: "Image",
							sortOrder: 0,
							thumbnailUrl: null,
		...
		},
		{
			...
			prices: {
				unitPrice: "9.95",
				pricebookEntryId: "01uHp00000PGIW2IAA",
				listPrice: null
			},
			...
			mediaGroups: [
				{
					...
					mediaItems: [
						{
							alternateText: null,
							contentVersionId: "5OUHp000000GhEpOA0",
							id: "2pmHp000000Y3sCIAC",
							mediaType: "Image",
							sortOrder: 0,
							thumbnailUrl: null,
		...
		},
		{
			...
			prices: {
				unitPrice: "12",
				pricebookEntryId: "01uHp00000PGIW3IAA",
				listPrice: null
			},
			...
			mediaGroups: [
				{
					...
					mediaItems: [
						{
							alternateText: null,
							contentVersionId: "5OUHp000000GhEqOA0",
							id: "2pmHp000000Y3sEIAS",
							mediaType: "Image",
							sortOrder: 0,
							thumbnailUrl: null,
